...
# After setting PRs/goals in detectPRsAndMilestones, also update consistency goals
# Find the consistency milestone check section and add consistency goal update after it
